...
:: Android packaging
set AND_CERT_NAME="heunjeokApp"
set AND_CERT_PASS=fd
set AND_CERT_FILE=cert\heunjeokApp.p12
...
set IOS_PROVISION=cert\heunjeokApp.mobileprovision
...
set APP_ID=air.heunjeokApp

:: Output packages
set DIST_PATH=dist
set DIST_NAME=heunjeokApp
